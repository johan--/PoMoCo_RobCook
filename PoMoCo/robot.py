...
class hexapod():
    # TODO define letter writing function (in this scope?)
...
class leg():
    # TODO add some class variables defining offsets and angles of legs for robot in Hexy co-ordinates
    # TODO define IK function(s) in this scope
